...
def build_model_feature_extraction():
    ...
    predictions = Dense(29, activation='softmax')(x)  # 29 letters and other asl symbols, therefore 29 output units w softmax activation
...
def main():
    ...
    print("Saving Model...")
    model.save("asl_transfer_learning_model.h5")
